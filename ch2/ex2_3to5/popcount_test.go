...
package ex2_3to5_test

import (
	"testing"

	"gopl.io/ch2/popcount"
	"gopl.io/ch2/ex2_3to5"
)
...
func BenchmarkPopCountByLooping(b *testing.B) {
	for i := 0; i < b.N; i++ {
		ex2_3to5.PopCountByLooping(0x1234567890ABCDEF)
	}
}

func BenchmarkPopCountBitwise(b *testing.B) {
	for i := 0; i < b.N; i++ {
		ex2_3to5.PopCountBitwise(0x1234567890ABCDEF)
	}
}

func BenchmarkPopCountRightmostBit(b *testing.B) {
	for i := 0; i < b.N; i++ {
		ex2_3to5.PopCountRightmostBit(0x1234567890ABCDEF)
	}
}
